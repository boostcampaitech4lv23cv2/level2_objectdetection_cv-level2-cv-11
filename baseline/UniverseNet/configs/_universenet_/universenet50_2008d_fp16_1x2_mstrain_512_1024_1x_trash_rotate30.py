_base_ = [
    ...
    '../_base_/datasets/trash_mstrain_512_1024_rotate30.py', # Trash Dataset
    ...
    hooks = [
        ...
        dict(type='MMDetWandbHook',
            init_kwargs=dict(
                ...
                name = '1129_kh_universenet50_2008d-rotate30', 
                tags = ['universenet', 'sgd', 'res2net50', 'mstrain_512_1024', '1x'],
                notes = 'UniverseNet50_2008d Rotate30', 
            ),
            interval = 50,
        )     
    ]
...
load_from = 'https://github.com/shinya7y/UniverseNet/releases/download/20.10/universenet50_2008d_fp16_4x4_mstrain_480_960_1x_coco_20201013_epoch_12-8d9334a9.pth'