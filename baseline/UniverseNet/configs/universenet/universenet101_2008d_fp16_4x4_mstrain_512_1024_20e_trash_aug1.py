_base_ = [
    ...
    './_base_/datasets/coco_detection_mstrain_512_1024_aug1.py', # Trash Dataset
    ...
    hooks = [
        ...
        dict(type='MMDetWandbHook',
            init_kwargs=dict(
                ...
                name = '1128_kh_universenet101_2008d-augmentation', 
                tags = ['universenet', 'sgd', 'res2net101', 'mstrain_512_1024'],
                notes = 'UniverseNet101_2008d configs/albu에서 가져온 Augmentation', 
            ),
            interval = 50,
        )     
    ]
