# CE vs Focal Loss 비교 실험.
# SGD로 하면 기울기 nan 되서 AdamW 기반으로 진행함
    ...
    hooks=[
        ...
        dict(type='MMDetWandbHook',
            ...
            init_kwargs=dict(
                ...
                name = '1125_kh_faster-rcnn_baseline_focal', 
                tags = ['resnet50', 'adamw', 'faster_rcnn', '512', 'focal'],
                notes = 'ce vs focal 비교', 
            ),
