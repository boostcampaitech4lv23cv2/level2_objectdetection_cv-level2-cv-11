    ...
    hooks=[
        ...
        dict(type='MMDetWandbHook',
            ...
            init_kwargs=dict(
                ...
                name = '1124_gh_dynamic-rcnn', 
                tags = ['dynamic_rcnn', 'resnet50', 'ce', 'smoothl1', 'coco', 'sgd', 'steplr', 'warmup'],
                notes = 'lr 제외 dynamic_rcnn/dynamic_rcnn_r50_fpn_1x_coco.py와 동일. lr=0.02 -> 0.001', 
            ),
